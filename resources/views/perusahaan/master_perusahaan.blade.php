...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion" id="accordionSidebar">
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('dashboard-perusahaan')}}">
            ...
            <li class="nav-item active">
                <a class="nav-link text-dark" href="{{route('dashboard-perusahaan')}}">
