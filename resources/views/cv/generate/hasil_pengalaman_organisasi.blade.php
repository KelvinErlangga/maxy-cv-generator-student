...
@section('title', 'Pengalaman Organisasi | CVRE GENERATE')
...
<div class="min-h-screen flex flex-col relative bg-gradient-to-b from-white via-purple-50 to-blue-50">
    ...
    <div class="absolute top-10 left-40 z-10">
        <a href="{{ route('cv', ['section' => 'pengalaman_organisasi']) }}" class="text-blue-700 hover:underline text-sm flex items-center">
    ...
    <div class="bg-white shadow-lg rounded-lg p-8 mx-auto z-10 mb-20" style="max-width: 800px; width: 100%;">
        ...
        <ul id="experience-list" class="space-y-4">
            ...
            <li class="border border-gray- rounded flex items-center justify-between p-4 shadow">
                <div class="flex items-center space-x-4">
                    ...
                    <!-- Detail Pengalaman -->
                    <div>
                        <h3 class="text-blue-700 font-semibold">Himpunan Teknik Informatika | Surabaya</h3>
                        <p class="text-gray-500 text-sm">Teknik Informatika | 2020 - 2023</p>
                    </div>
                </div>
            ...
            <li class="border border-gray- rounded flex items-center justify-between p-4 shadow">
                <div class="flex items-center space-x-4">
                    ...
                    <!-- Detail Pengalaman -->
                    <div>
                        <h3 class="text-blue-700 font-semibold">Surabaya Dev | Surabaya</h3>
                        <p class="text-gray-500 text-sm">Event Organizer | 2018 - Now</p>
                    </div>
                </div>
        ...
        <a
            href="{{ route('cv', ['section' => 'pengalaman_organisasi']) }}"
            class="mt-6 w-full py-4 bg-blue-100 text-blue-700 text-sm font-bold rounded shadow hover:bg-blue-200 focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 transition text-center block">+ Tambah Pengalaman Organisasi
        </a>
