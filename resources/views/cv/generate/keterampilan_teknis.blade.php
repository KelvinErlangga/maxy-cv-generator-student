...
@section('title', 'Keterampilan Teknis | CVRE GENERATE')

@section('content')
<!-- Form Keterampilan Teknis -->
<div class="min-h-screen flex flex-col relative bg-gradient-to-b from-white via-purple-50 to-blue-50">
    ...
    <div class="absolute top-10 left-40 z-10">
        <a href="{{ route('cv', ['section' => 'bahasa']) }}" class="text-blue-700 hover:underline text-sm flex items-center">
