...
<body class="min-h-screen flex flex-col relative bg-gradient-to-b from-white via-purple-50 to-blue-50" style="font-family: 'Poppins', sans-serif">
    ...
    <div class="bg-white shadow-lg rounded-lg p-8 mx-auto z-10 mb-20" style="max-width: 800px; width: 100%;">
        ...
        <!-- Form -->
        <form method="POST" action="{{route('pelamar.curriculum_vitae.organization.updateOrganization', [$curriculumVitaeUser->id, $organization->id])}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-4 gap-4">
                ...
                <div class="col-span-2">
                    <input
                        ...
                        value="{{$organization->position_organization}}"
                ...
                <div class="col-span-2">
                    <input
                        ...
                        placeholder="Kota"
                        value="{{$organization->city_organization}}"
                        class="block w-full rounded border border-gray-300 focus:ring-blue-500 focus:border-blue-500 focus:ring-2 focus:outline-none"
                        style="height: 45px; padding: 0 16px"
                        required />
                </div>
                ...
                <div class="col-span-4">
                    ...
                    <input id="description_organization" name="description_organization" type="hidden" value="{{$organization->description_organization}}"></input>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var ringkasanInput = document.querySelector('input#description_organization');
            if (ringkasanInput.value) {
                quill.clipboard.dangerouslyPasteHTML(ringkasanInput.value); // Mengatur konten awal editor
            }
