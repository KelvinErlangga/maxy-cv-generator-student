    ...
    <div class="container mx-auto text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                <img src="{{ asset('images/Our Team/1.png') }}" alt="Abrar Adyasakha"
            ...
            <!-- Card 2 -->
            <div class="bg-white shadow-lg rounded-lg p-6">
                <img src="{{ asset('images/Our Team/1.png') }}" alt="Febriana"
                    class="w-36 h-36 rounded-full mx-auto mb-4 object-cover">
            ...
            <!-- Card 3 -->
            <div class="bg-white shadow-lg rounded-lg p-6">
                <img src="{{ asset('images/Our Team/1.png') }}" alt="Muhammad Ferry K"
                    class="w-36 h-36 rounded-full mx-auto mb-4 object-cover">
            ...
            <!-- Card 4 -->
            <div class="bg-white shadow-lg rounded-lg p-6">
                <img src="{{ asset('images/Our Team/2.png') }}" alt="Nazwa Nurfadiya R"
                    class="w-36 h-36 rounded-full mx-auto mb-4 object-cover">
            ...
            <!-- Card 5 -->
            <div class="bg-white shadow-lg rounded-lg p-6">
                <img src="{{ asset('images/Our Team/2.png') }}" alt="Widitha Fasha"
                    class="w-36 h-36 rounded-full mx-auto mb-4 object-cover">
            ...
            <!-- Card 6 -->
            <div class="bg-white shadow-lg rounded-lg p-6">
                <img src="{{ asset('images/Our Team/2.png') }}" alt="Jesika Yohanna S"
                    class="w-36 h-36 rounded-full mx-auto mb-4 object-cover">
            ...
            <!-- Card 7 -->
            <div class="bg-white shadow-lg rounded-lg p-6">
                <img src="{{ asset('images/Our Team/2.png') }}" alt="Yulianawati"
                    class="w-36 h-36 rounded-full mx-auto mb-4 object-cover">
            ...
            <!-- Card 8 -->
            <div class="bg-white shadow-lg rounded-lg p-6">
                <img src="{{ asset('images/Our Team/1.png') }}" alt="Kelvin Erlangga S"
                    class="w-36 h-36 rounded-full mx-auto mb-4 object-cover">
            ...
            <!-- Card 9 -->
            <div class="bg-white shadow-lg rounded-lg p-6">
                <img src="{{ asset('images/Our Team/1.png') }}" alt="Richard Diga A"
                    class="w-36 h-36 rounded-full mx-auto mb-4 object-cover">
